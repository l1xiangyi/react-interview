...
export function RepositoryOption({repoName, creator, stars, forks, issues, language}: RepoOptionProps) {
  return (
    <Combobox.Option
        ...
        <>
          <header className="flex items-center">
            <CpuChipIcon
              ...
              aria-hidden="true"
            />
            <span className="ml-1 font-bold flex-auto truncate">{repoName} repoName</span>
          </header>
